            ...
            if (_dayItems != null)
            {
                ...
                for (int i = 0; i < 48; i++)
                {
                    ...
                    if (startTime.Hour >= 8 && startTime.Hour <= 17)
                        timeslot.SetBinding(ZapCalendar.BackgroundProperty, GetOwnerBinding("PeakTimeslotBackground"));
                    else
                        timeslot.SetBinding(ZapCalendar.BackgroundProperty, GetOwnerBinding("OffPeakTimeslotBackground"));
