...
{
    [TemplatePart(Name = ZapCalendar.ElementDay, Type = typeof(CalendarDay))]
    [TemplatePart(Name = ZapCalendar.ElementDayHeader, Type = typeof(CalendarDayHeader))]
    [TemplatePart(Name = ZapCalendar.ElementLedger, Type = typeof(CalendarLedger))]
    [TemplatePart(Name = ZapCalendar.ElementScrollViewer, Type = typeof(ScrollViewer))]
